...
//        ).isInstanceOf(IllegalStateException.class);
            ...
            // Проверка базового функционала с целыми числами, с использованием утверждений AssertJ:
        assertThat(Calculator.calculatingDiscount(100.00, 10)).isEqualTo(90);
        assertThat(Calculator.calculatingDiscount(200.00, 2)).isEqualTo(196);
        assertThat(Calculator.calculatingDiscount(250.00, 5)).isEqualTo(237.50);
        assertThat(Calculator.calculatingDiscount(345, 50)).isEqualTo(172.50);

        // Проверка ожидаемого исключения, с использованием утверждений AssertJ:
        assertThatThrownBy(() -> Calculator.calculatingDiscount(-87, 4)).isInstanceOf(IllegalStateException.class);
